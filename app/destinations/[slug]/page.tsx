        ...
        <div className="relative z-20 w-full h-full flex flex-col justify-center px-6 md:px-20 lg:px-24 xl:px-32">
          <ScrollAnimation animation="fade" delay={100}>
            <div className="flex flex-wrap items-center gap-2 sm:gap-4 mb-3 sm:mb-4">
              ...
              <span className={`px-2 py-1 sm:px-3 sm:py-1 rounded-full text-xs sm:text-sm font-medium ${getDifficultyColor(destination.difficulty)}`}>
          ...
          <ScrollAnimation animation="fade" delay={400}>
            <div className="flex flex-wrap items-center gap-3 sm:gap-4 md:gap-6 text-white">
              <div className="flex items-center gap-1 sm:gap-2">
                ...
                <span className="text-xs sm:text-sm md:text-base">{destination.duration}</span>
              </div>
              <div className="flex items-center gap-1 sm:gap-2">
                <Icon name="wb_sunny" size="sm" />
                <span className="text-xs sm:text-sm md:text-base">{destination.bestTime}</span>
              </div>
              <div className="flex items-center gap-1 sm:gap-2">
                <Icon name="location_on" size="sm" />
                <span className="text-xs sm:text-sm md:text-base">{destination.region}</span>
              </div>
            </div>
          </ScrollAnimation>
        </div>
        ...
        <div className="w-full">
          <div className="grid lg:grid-cols-3 gap-6 sm:gap-8 md:gap-12">
            <div className="lg:col-span-2">
              <ScrollAnimation animation="fade" delay={100}>
                <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-4 sm:mb-6">About {destination.name}</h2>
              ...
              <ScrollAnimation animation="fade" delay={200}>
                <h3 className="text-lg sm:text-xl md:text-2xl font-bold mb-4 sm:mb-6">Highlights & Experiences</h3>
              ...
              <ScrollAnimation animation="scale" delay={300}>
                <div className="bg-white dark:bg-background-dark rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-gray-100 dark:border-white/10 lg:sticky lg:top-24">
                  <ScrollAnimation animation="fade" delay={350}>
                    <h3 className="text-lg sm:text-xl font-bold mb-4 sm:mb-6">Plan Your Visit</h3>
                  </ScrollAnimation>
                  ...
                  <div className="space-y-3 sm:space-y-4 mb-4 sm:mb-6">
                    <ScrollAnimation animation="slide-right" delay={400}>
                      <div className="flex justify-between items-center">
                        ...
                        <span className="font-semibold text-sm sm:text-base">{destination.duration}</span>
                      </div>
                    </ScrollAnimation>
                    <ScrollAnimation animation="slide-right" delay={450}>
                      <div className="flex justify-between items-center">
                        <span className="text-sm sm:text-base text-gray-600 dark:text-gray-400">Best Time</span>
                        <span className="font-semibold text-sm sm:text-base">{destination.bestTime}</span>
                      </div>
                    </ScrollAnimation>
                    <ScrollAnimation animation="slide-right" delay={500}>
                      <div className="flex justify-between items-center">
                        <span className="text-sm sm:text-base text-gray-600 dark:text-gray-400">Difficulty</span>
                        <span className={`px-2 py-1 rounded text-xs sm:text-sm font-medium ${getDifficultyColor(destination.difficulty)}`}>
                          {destination.difficulty}
                        </span>
                      </div>
                    </ScrollAnimation>
                    <ScrollAnimation animation="slide-right" delay={550}>
                      <div className="flex justify-between items-center">
                        <span className="text-sm sm:text-base text-gray-600 dark:text-gray-400">Region</span>
                        <span className="font-semibold text-sm sm:text-base">{destination.region}</span>
                      </div>
                    </ScrollAnimation>
                  </div>
