  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 px-6 md:px-20 mt-6">
      ...
      <div className="lg:col-span-2 flex flex-col">
          ...
          {tour.itinerary.map((item, index) => (
            <div key={index} className="relative pl-14">
              ...
              <div className="flex flex-col gap-2">
                ...
                {item.accommodation && (
                  <div className="mt-3 p-4 bg-white dark:bg-white/5 rounded-lg border border-dashed border-[#ccc] dark:border-white/20 flex items-center gap-4">
                    <img 
        ...
        {/* Customization Note */}
        <div className="mt-12 p-6 bg-primary/10 rounded-xl border border-primary/30 flex gap-4">
      ...
      <div className="lg:col-span-1">
        <div className="sticky top-24 space-y-6">
          {/* Price Card */}
          <div className="bg-white dark:bg-white/5 p-6 rounded-xl border border-[#f0f4f0] dark:border-white/10 shadow-sm">
            ...
            <Button variant="primary" className="w-full py-4 text-lg hover:scale-[1.02] active:scale-[0.98]">
              Reserve this tour
            </Button>
          ...
          <div className="bg-white dark:bg-white/5 p-6 rounded-xl border border-[#f0f4f0] dark:border-white/10 shadow-sm">
            ...
            <ul className="space-y-3">
              {tour.excluded.map((item, index) => (
                <li key={index} className="flex items-start gap-3 text-sm opacity-70">
          ...
          {/* Contact/Help */}
          <div className="p-6 bg-[#111811] dark:bg-[#081108] text-white rounded-xl text-center">
