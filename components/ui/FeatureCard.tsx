...
const FeatureCard = ({ icon, title, description }: FeatureCardProps) => {
  return (
    <Card variant="elevated" padding="lg" className="group h-full flex flex-col">
      ...
      <p className="text-gray-600 dark:text-gray-400 leading-relaxed flex-1">{description}</p>
    </Card>
  )
}
